    ...
    <div className="bg-vellum pt-32 pb-32">
      <div className="container mx-auto px-6 lg:px-24">
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-serif font-extrabold mb-8 text-savannah-dark">Travel as a Force for Good</h1>
          <p className="text-lg lg:text-2xl text-gray-600 leading-relaxed font-serif italic">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-24 items-center">
           <img 
             ...
             className="w-full h-[300px] lg:h-[500px] object-cover rounded-sm shadow-2xl" 
             alt="Rangers in the field" 
           />
           <div className="flex flex-col justify-center space-y-8">
              <h2 className="text-3xl lg:text-4xl font-serif font-bold text-savannah-dark">Community & Wildlife</h2>
        ...
        <div className="text-center mb-16">
           ...
           <div className="flex flex-wrap justify-center gap-4 lg:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
              {/* Simulated logos */}
              <div className="text-base lg:text-lg font-bold border-2 border-clay text-gray-500 px-6 py-3 lg:px-8 lg:py-4 rounded-sm hover:border-ochre hover:text-ochre transition-colors">Mara Elephant Project</div>
              <div className="text-base lg:text-lg font-bold border-2 border-clay text-gray-500 px-6 py-3 lg:px-8 lg:py-4 rounded-sm hover:border-ochre hover:text-ochre transition-colors">The Sheldrick Trust</div>
              <div className="text-base lg:text-lg font-bold border-2 border-clay text-gray-500 px-6 py-3 lg:px-8 lg:py-4 rounded-sm hover:border-ochre hover:text-ochre transition-colors">Ecotourism Kenya</div>
              <div className="text-base lg:text-lg font-bold border-2 border-clay text-gray-500 px-6 py-3 lg:px-8 lg:py-4 rounded-sm hover:border-ochre hover:text-ochre transition-colors">Lion Guardians</div>
           </div>
        </div>
      </div>
    </div>
