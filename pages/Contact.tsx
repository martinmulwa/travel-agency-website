  ...
  return (
    <div className="pt-32 min-h-screen bg-vellum pb-24">
      <div className="container mx-auto px-6 lg:px-24">
        <div className="mb-20">
            <h1 className="text-5xl lg:text-7xl font-serif font-bold text-savannah-dark mb-8">Let's Talk Safari</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-12">
             <div className="grid sm:grid-cols-2 gap-8">
                <div className="bg-white p-10 shadow-sm border-t-4 border-ochre rounded-sm hover:shadow-md transition-shadow">
             ...
             {/* Map Placeholder */}
             <div className="w-full h-80 bg-clay/20 rounded-sm flex items-center justify-center border border-clay/50">
          ...
          {/* Contact Form */}
          <div className="bg-white p-10 lg:p-16 shadow-2xl rounded-sm h-fit">
             <h3 className="text-3xl font-serif font-bold mb-10 text-savannah-dark">Send a Message</h3>
             <form onSubmit={handleSubmit} name="contact-form" className="space-y-8">
