      ...
      <div className="relative h-[70vh]">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
           <div className="text-center pt-20">
               ...
               <h1 className="text-5xl md:text-8xl font-serif font-extrabold text-white drop-shadow-xl">Our Story</h1>
           </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-24 py-24">
        ...
        <div className="grid lg:grid-cols-12 gap-16 mb-32">
           <div className="lg:col-span-4">
              ...
              <h2 className="text-4xl font-serif font-bold text-savannah-dark mb-6 leading-tight">Born from a love for the wild.</h2>
           ...
           <div className="lg:col-span-8 text-gray-700 space-y-8 text-lg leading-relaxed font-sans">
              ...
              <p className="font-serif italic text-2xl text-savannah-dark pl-6 border-l-4 border-ochre">
        ...
        <div className="mb-32">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-serif font-bold text-savannah-dark">Meet The Family</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            {TEAM_MEMBERS.map(member => (
              <div key={member.id} className="group text-center">
                <div className="relative overflow-hidden rounded-full w-56 h-56 mx-auto mb-8 border-4 border-clay shadow-xl">
        ...
        {/* Values */}
        <div className="bg-savannah-dark text-vellum p-12 lg:p-24 rounded-sm shadow-2xl">
           <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                <span className="text-ochre font-mono text-xs uppercase tracking-widest block mb-6">Why Choose Us</span>
                <h2 className="text-4xl font-serif font-bold mb-10">The Horizon Standard</h2>
